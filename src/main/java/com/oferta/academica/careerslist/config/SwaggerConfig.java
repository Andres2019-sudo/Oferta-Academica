package com.oferta.academica.careerslist.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Oferta Académica")
				.description(
						"Oferta Académica. https://github.com/Andres2019-sudo/Oferta-Academica.git\r\n" + 
						"")
				.build();
	}
